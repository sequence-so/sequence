...
import IconTrigger from "../../../public/icon_trigger.svg";
          ...
          <div className={styles.container_content}>
            ...
            {state === "activity" ? (
              ...
              <>
                ...
                <p>
                  Your SQL script must contain at least one primary key and at
                  least one numeric value (like a count). Click here for an
                  example.{" "}
                </p>
                <textarea />
                <BlueButton
